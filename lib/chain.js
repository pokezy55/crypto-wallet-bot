    ...
    tokens: [
      {
        ...
        decimals: 18,
        isNative: true,
        logo: 'https://cdn.web3icons.dev/tokens/eth.svg'
      },
      {
        symbol: 'USDT',
        name: 'Tether USD',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/usdt.svg'
      },
      {
        symbol: 'USDC',
        name: 'USD Coin',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/usdc.svg'
      },
      {
        symbol: 'WBTC',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/wbtc.svg'
      },
      {
        symbol: 'LINK',
        name: 'Chainlink',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/link.svg'
      },
      {
        symbol: 'AAVE',
        name: 'Aave',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/aave.svg'
      },
      {
        symbol: 'PEPE',
        name: 'Pepe',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/pepe.svg'
      }
    ]
  },
  bsc: {
    ...
    tokens: [
      {
        ...
        decimals: 18,
        isNative: true,
        logo: 'https://cdn.web3icons.dev/tokens/bnb.svg'
      },
      {
        symbol: 'USDT',
        name: 'Tether USD',
      ...
      },
      {
        ...
        logo: 'https://cdn.web3icons.dev/tokens/doge.svg'
      },
      {
        symbol: 'LINK',
        name: 'Chainlink',
    ...
    tokens: [
      {
        ...
        decimals: 18,
        isNative: true,
        logo: 'https://cdn.web3icons.dev/tokens/matic.svg'
      },
      {
        symbol: 'USDT',
        name: 'Tether USD',
  ...
  base: {
    ...
    tokens: [
      ...
      },
      {
        ...
        logo: 'https://cdn.web3icons.dev/tokens/dai.svg'
      },
      {
        symbol: 'WETH',
        name: 'Wrapped Ether',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/weth.svg'
      },
      {
        symbol: 'ZORA',
        name: 'Zora',
        ...
        logo: 'https://cdn.web3icons.dev/tokens/zora.svg'
      }
    ]
  }
};
